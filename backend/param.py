...
def parse_args():
    ...
    parser.add_argument('--pvqaimgv', type=str, default='1',
    ...
    parser.add_argument('--loadLXMERT', dest='load_lxmert', type=str, default="E:/UoM/__Sem7/fyp/Project/PVQA0/baselines/method1/snap/pretrained/model",
